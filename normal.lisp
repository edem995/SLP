...
(defun atm (lst)
  ((lambda (x y)  
     (cond ((null x) t) ((not (atom x)) nil)
        (t (atm y)))) (car lst) (cdr lst)))
;;;
;;; (atm '(1 2 3 4))
;;; t
;;; (atm '(1 (2 3 4)))
...
(setf (get 'ПИТЕР 'x) 194)
(setf (get 'ПИТЕР 'y) 100)
(setf (get 'МОСКВА 'x) 461)
(setf (get 'МОСКВА 'y) 9498)
;;;
;;;(Расстояние 'МСК 'ПИТЕР)
